...
public class PLVActivity extends BaseActivity {

    public static PLVActivity ma;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("PLV Activity");
        recyclerView = (RecyclerView) findViewById(R.id.list);
        recyclerView.setLayoutManager(new LinearLayoutManager(PLVActivity.this));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add) {
            ...
            Intent tes = new Intent(PLVActivity.this, MainActivity.class);
            startActivity(tes);
        }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_SELECT, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    Toast.makeText(PLVActivity.this,jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.hide();
                Toast.makeText(PLVActivity.this, "Failed", Toast.LENGTH_SHORT).show();
            }
        }){
...
//                Log.d(null, mobile);
        ...
        RequestHandler.getInstance(PLVActivity.this).addToRequestQueue(stringRequest);
