...
public class PLVAdapter extends RecyclerView.Adapter<PLVAdapter.ViewHolder>{



    private List<ModelPlv> listItems;
    private Context context;
    private ProgressDialog dialog;


    public PLVAdapter(List<ModelPlv> listItems, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final ModelPlv listItem = listItems.get(position);
        ...
        holder.card_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                final CharSequence[] dialogitem = {"View Grievance"," Complete and submit Grievance back to DLSA Authotiry"};
                builder.setTitle(listItem.getUId());   //                builder.setTitle(listItem.getName());
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i){
                            ...
                            case 1:
                                ...
                                Intent intent2 = new Intent(view.getContext(), PLVUpdateActivity.class);
                            ...
                            case 2 :
                                ...
                                builderDel.setMessage("Are You Sure, You Want to Withdraw Grievance?");
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_DELETE, new Response.Listener<String>() {
                                            ...
                                            public void onResponse(String response) {
                                                dialog.hide();
                                                dialog.dismiss();
                                                Toast.makeText(view.getContext(),"Grievance Successfully Withdrawn "+ listItem.getName(), Toast.LENGTH_LONG).show();
