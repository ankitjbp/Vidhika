...
public class LegalAidActivity extends AppCompatActivity {

    public static LegalAidActivity ma;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(LegalAidActivity.this));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add) {
            ...
            Intent tes = new Intent(LegalAidActivity.this, MainActivity.class);
            startActivity(tes);
        }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_SELECT, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    Toast.makeText(LegalAidActivity.this,jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.hide();
                Toast.makeText(LegalAidActivity.this, "Failed", Toast.LENGTH_SHORT).show();
            }
        }){
...
//                Log.d(null, mobile);
        ...
        RequestHandler.getInstance(LegalAidActivity.this).addToRequestQueue(stringRequest);
