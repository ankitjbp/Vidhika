...
public class SlsaActivity extends BaseActivity {

    public static SlsaActivity ma;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(SlsaActivity.this));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add) {
            ...
            Intent tes = new Intent(SlsaActivity.this, MainActivity.class);
            startActivity(tes);
        }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_SELECT, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    Toast.makeText(SlsaActivity.this,jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.hide();
                Toast.makeText(SlsaActivity.this, "Failed", Toast.LENGTH_SHORT).show();
            }
        }){
...
//                Log.d(null, mobile);
        ...
        RequestHandler.getInstance(SlsaActivity.this).addToRequestQueue(stringRequest);
