...
public class DLSAAdapter extends RecyclerView.Adapter<DLSAAdapter.ViewHolder>{



    private List<ModelDlsa> listItems;
    private Context context;
    private ProgressDialog dialog;


    public DLSAAdapter(List<ModelDlsa> listItems, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final ModelDlsa listItem = listItems.get(position);
        ...
        holder.card_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                final CharSequence[] dialogitem = {"View Grievance","Take Action on Grievance"};
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i){
                            ...
                            case 1:
                                ...
                                Intent intent2 = new Intent(view.getContext(), UpdateActivity.class);
