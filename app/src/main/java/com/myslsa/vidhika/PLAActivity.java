...
public class PLAActivity extends BaseActivity {

    public static PLAActivity ma;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(PLAActivity.this));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add) {
            ...
            Intent tes = new Intent(PLAActivity.this, MainActivity.class);
            startActivity(tes);
        }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_SELECT, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    Toast.makeText(PLAActivity.this,jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.hide();
                Toast.makeText(PLAActivity.this, "Failed", Toast.LENGTH_SHORT).show();
            }
        }){
...
//                Log.d(null, mobile);
        ...
        RequestHandler.getInstance(PLAActivity.this).addToRequestQueue(stringRequest);
