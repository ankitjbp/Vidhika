                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_ADD, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try{
                                ...
                                Toast.makeText(GrievanceActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
...
//                                    ListActivity.ma.refresh_list();
                        ...
                        public void onErrorResponse(VolleyError error) {
                            progressDialog.hide();
                            Toast.makeText(GrievanceActivity.this, "Not Able To Submit Grievance",Toast.LENGTH_SHORT).show();
                        }
                    }){
...
//                            params.put("help_type",help_type.toString());
                    ...
                    RequestHandler.getInstance(GrievanceActivity.this).addToRequestQueue(stringRequest);
