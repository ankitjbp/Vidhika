...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_dlsa);
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_UPDATE, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try{
                                ...
                                Intent intent=new Intent(UpdateActivity.this,DLSAAllotedListActivity.class);
...
//                            params.put("address",Address);
    ...
    private void getDataASIGNEEs(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST,Constants.URL_GET_ALL_USERS,
    ...
    private void getASIGNEEs(JSONArray j){
        ...
        ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(UpdateActivity.this,simple_spinner_item, dlao);
